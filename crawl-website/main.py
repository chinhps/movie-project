    ...
    def crawl(self, url):
        ...
        for genre in anime_genres:
            response = requests.post(url="http://localhost:8000/api/admin/categories/upsert", json={
                ...
                "authorization": "Bearer 2oawXcDlxx-05UCEjdxmuromfcJ3P2Q0ziNX0e04SYSX3MAIgfc3iF__MmrwDjEeh4QcDMIJA0FND6mAdxlLATYHODukZszRAVK3JazAGz9qzvTneIQ4dbbr1zTpoQhnTEDcHbO2BnkSC05WbsGa1w=="
            })
